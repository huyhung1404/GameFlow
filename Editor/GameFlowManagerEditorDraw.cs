...
namespace GameFlow.Editor
{
    ...
    public class GameFlowManagerEditorDraw
    {
        ...
        private void Register()
        {
            ...
            RegisterCoreContent(_root.Q<VisualElement>("core_content"),
                _serializedObject.FindProperty(nameof(GameFlowManager.AutoGenerateRuntimeManager)),
                _serializedObject.FindProperty(nameof(GameFlowManager.AutoGenerateRuntimeManagerData)));
        }
        ...
        private void RegisterCoreContent(VisualElement coreRoot, SerializedProperty autoGenerateProperty, SerializedProperty autoGenerateDataProperty)
        {
        }
    }
}